...
Inherits COM.IDispatch
	#tag Method, Flags = &h0
		Sub Constructor(connectEvents As Boolean = False)
		    ...
		    riid = COM.IIDFromString( "{011567B1-CC4C-11D5-A32D-000629A2F326}" )
		    clsid = COM.IIDFromString( "{011567B2-CC4C-11D5-A32D-000629A2F326}" )
	...
	#tag Method, Flags = &h0
		Function Item(IODdtName_Param As String, Id_Param As Integer) As UnityProServer.IIODdt
		  #if TargetWin32
