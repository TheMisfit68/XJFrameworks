...
Inherits COM.IDispatch
	...
	#tag Method, Flags = &h0
		Sub put_Name(NewName_Param As String)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New put_Name_Func1(mThis.Ptr( 0 ).Ptr(20 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New Protection_Get_Func1( mThis.Ptr( 0 ).Ptr( 19 * COM.SIZEOF_PTR ) )
		...
		#tag Setter
			Set
			  #if TargetWindows
			    If mThis = Nil Then Raise New NilObjectException
			    Dim func As New Protection_Put_Func1( mThis.Ptr( 0 ).Ptr( 18 * COM.SIZEOF_PTR ) )
