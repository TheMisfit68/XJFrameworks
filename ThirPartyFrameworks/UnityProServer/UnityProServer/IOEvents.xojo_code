#tag Class
Protected Class IOEvents
Inherits COM.IDispatch
	#tag Method, Flags = &h0
		Function Add(Language_Param As epsrLanguage, IOEventNumber_Param As Integer) As UnityProServer.IIOEvent
		  #if TargetWin32
	...
	#tag Method, Flags = &h0
		Sub Constructor(connectEvents As Boolean = False)
		    ...
		    riid = COM.IIDFromString( "{DA45CD51-C7A8-11D4-A251-0006290515BB}" )
		    clsid = COM.IIDFromString( "{5AD05D10-130F-11D5-A24A-0006296240B1}" )
	...
	#tag Method, Flags = &h0
		Function Item(Key_Param As Variant, Id_Param As Integer) As UnityProServer.IIOEvent
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
