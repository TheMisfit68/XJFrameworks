...
Inherits COM.IDispatch
	#tag Method, Flags = &h0
		Sub BreakNetlink()
		    ...
		    Dim func As New BreakNetlink_Func0(mThis.Ptr( 0 ).Ptr(28 * COM.SIZEOF_PTR ))
	...
	#tag Method, Flags = &h0
		Sub CloseEditorControl(bstrHMIRWPasswrd_Param As String)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New CloseEditorControl_Func1(mThis.Ptr( 0 ).Ptr(27 * COM.SIZEOF_PTR ))
	...
	#tag Method, Flags = &h0
		Sub Constructor(connectEvents As Boolean = False)
		    ...
		    riid = COM.IIDFromString( "{096A0962-6EFD-11D5-88FC-00062926BB4F}" )
		    clsid = COM.IIDFromString( "{096A0961-6EFD-11D5-88FC-00062926BB4F}" )
	...
	#tag Method, Flags = &h0
		Sub DisplayEditorControl(bstrHMIRWPasswrd_Param As String)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New DisplayEditorControl_Func1(mThis.Ptr( 0 ).Ptr(26 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
		    Dim Local_bstrHMIRWPasswrd_Param As Ptr
		    Local_bstrHMIRWPasswrd_Param = COM.SysAllocString( bstrHMIRWPasswrd_Param )
		    resultCode = func.Invoke(mThis, Local_bstrHMIRWPasswrd_Param)
	...
	#tag Method, Flags = &h0
		Sub GetGlobalData(GroupAddress_Param As Variant, GroupName_Param As Variant)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New GetGlobalData_Func2(mThis.Ptr( 0 ).Ptr(22 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Sub GetNetworkInfo(NetworkName_Param As Variant, NetworkFamily_Param As Variant, NetworkComment_Param As Variant, bIsAttached_Param As Variant, AdressPath_Param As Variant)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New GetNetworkInfo_Func5(mThis.Ptr( 0 ).Ptr(13 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Sub GetServiceMessaging(IPAddressConf_Param As Variant, IPAddress_Param As Variant, SubNetwork_Param As Variant, GatewayAddress_Param As Variant, XWayProfile_Param As Variant, Network_Param As Variant, Station_Param As Variant, EthernetConf_Param As Variant)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New GetServiceMessaging_Func8(mThis.Ptr( 0 ).Ptr(24 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Sub GetStationNumber(StationNumber_Param As Variant)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New GetStationNumber_Func1(mThis.Ptr( 0 ).Ptr(20 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Sub SetGlobalData(GroupAddress_Param As String, GroupName_Param As String)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New SetGlobalData_Func2(mThis.Ptr( 0 ).Ptr(21 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Sub SetServiceMessaging(IPAddressConf_Param As Integer, IPAddress_Param As String, SubNetwork_Param As String, GatewayAddress_Param As String, lXWayProfile_Param As Integer, Network_Param As Integer, Station_Param As Integer, EthernetConf_Param As Integer)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New SetServiceMessaging_Func8(mThis.Ptr( 0 ).Ptr(23 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Sub SetStationNumber(StationNumber_Param As Integer)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New SetStationNumber_Func1(mThis.Ptr( 0 ).Ptr(19 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New FamilyName_Get_Func1( mThis.Ptr( 0 ).Ptr( 25 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New IsAttached_Get_Func1( mThis.Ptr( 0 ).Ptr( 18 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New TypeName_Get_Func1( mThis.Ptr( 0 ).Ptr( 12 * COM.SIZEOF_PTR ) )
