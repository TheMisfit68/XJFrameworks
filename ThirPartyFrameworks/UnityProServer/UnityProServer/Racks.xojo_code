...
Inherits COM.IDispatch
	...
	#tag DelegateDeclaration, Flags = &h1
		Protected Delegate Function AddChild_Func5(this As Ptr, lTopoNumber_Param As Integer, lExtendedNumber_Param As Integer, bsPartNumber_Param As Ptr, bsVersion_Param As Ptr, ByRef ppNewRack_Param As Ptr) As Integer
	...
	#tag Method, Flags = &h0
		Sub Constructor(connectEvents As Boolean = False)
		    ...
		    riid = COM.IIDFromString( "{D262E9A3-12F7-4A64-9B05-DD19513028E2}" )
		    clsid = COM.IIDFromString( "{258CC4E6-860B-4308-B3AA-2343864211B2}" )
	...
	#tag DelegateDeclaration, Flags = &h1
		Protected Delegate Function Item_Func5(this As Ptr, lTopoNumber_Param As Integer, lExtendedNumber_Param As Integer, Id_Param As Integer, IndexNameKey_Param As Ptr, ByRef ppNewRack_Param As Ptr) As Integer
	#tag EndDelegateDeclaration
	...
	#tag DelegateDeclaration, Flags = &h1
		Protected Delegate Function LocalChild_Get_Func1(this As Ptr, ByRef ppNewRack_Param As Ptr) As Integer
	#tag EndDelegateDeclaration
	...
	#tag DelegateDeclaration, Flags = &h1
		Protected Delegate Function ReplaceChild_Func7(this As Ptr, lTopoNumber_Param As Integer, lExtendedNumber_Param As Integer, bsActualPartNumber_Param As Ptr, bsActualVersion_Param As Ptr, bsNewPartNumber_Param As Ptr, bsNewVersion_Param As Ptr, ByRef ppNewRack_Param As Ptr) As Integer
	#tag EndDelegateDeclaration
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			...
			End Get
		#tag EndGetter
		LocalChild As UnityProServer.IRack
	#tag EndComputedProperty
