...
Inherits COM.IDispatch
	...
	#tag Method, Flags = &h0
		Function Item(Key_Param As Variant, Id_Param As Integer) As UnityProServer.ISection
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
	...
	#tag Method, Flags = &h0
		Sub Move(IndexKeyFrom_Param As Integer, IndexKeyTo_Param As Integer)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New Move_Func2(mThis.Ptr( 0 ).Ptr(12 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
