#tag Class
Protected Class DIApplicationEvents
Inherits COM.IDispatch
	...
	#tag Method, Flags = &h0
		Shared Function IID() As MemoryBlock
		  Return COM.IIDFromString("{1527A481-E539-11D3-A1CC-000629A2F326}")
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub Operator_Convert(rhs As COM.IUnknown)
		  ...
		  Dim p As Ptr
		  If 0 = rhs.QueryInterface( UnityProServer.DIApplicationEvents.IID, p ) Then
		    mThis = p
		  Else
