...
Inherits COM.IDispatch
	...
	#tag Method, Flags = &h0
		Sub ListSubfields(SubfieldsNamesList_Param As Variant, SubfieldsTypeNameList_Param As Variant, SubfieldsTypeCategoryList_Param As Variant, SubfieldsNatureList_Param As Variant)
		    ...
		    Dim func As New ListSubfields_Func4(mThis.Ptr( 0 ).Ptr(16 * COM.SIZEOF_PTR ))
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New InfoSignature_Get_Func1( mThis.Ptr( 0 ).Ptr( 14 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New InfoSize_Get_Func1( mThis.Ptr( 0 ).Ptr( 13 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New InfoVersion_Get_Func1( mThis.Ptr( 0 ).Ptr( 12 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New IsTypeDiagnostic_Get_Func1( mThis.Ptr( 0 ).Ptr( 15 * COM.SIZEOF_PTR ) )
