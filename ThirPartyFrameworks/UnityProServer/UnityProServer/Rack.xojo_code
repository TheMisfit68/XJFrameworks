...
Inherits COM.IDispatch
	...
	#tag Method, Flags = &h0
		Function IsExtended() As Integer
		  If mThis = Nil Then Raise New NilObjectException
		  Dim func As New IsExtended_Func1(mThis.Ptr( 0 ).Ptr(36 ))
		  Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Function IsMain() As Integer
		  If mThis = Nil Then Raise New NilObjectException
		  Dim func As New IsMain_Func1(mThis.Ptr( 0 ).Ptr(56 ))
		  Dim resultCode As Integer
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  Dim func As New Modules_Get_Func1( mThis.Ptr( 0 ).Ptr( 72 ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  Dim func As New PartNumber_Get_Func1( mThis.Ptr( 0 ).Ptr( 52 ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  Dim func As New TopoAddress_Get_Func1( mThis.Ptr( 0 ).Ptr( 44 ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  Dim func As New Version_Get_Func1( mThis.Ptr( 0 ).Ptr( 48 ) )
