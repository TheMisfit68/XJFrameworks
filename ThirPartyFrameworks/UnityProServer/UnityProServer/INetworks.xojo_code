...
Inherits COM.IDispatch
	...
	#tag Method, Flags = &h0
		Function Item(NetworkName_Param As String, Id_Param As Integer) As UnityProServer.INetwork
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
	...
	#tag Method, Flags = &h0
		Function ListNetwork(NetworkFamily_Param As String, Filter_Param As Variant) As Variant
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New ListNetwork_Func3(mThis.Ptr( 0 ).Ptr(12 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
		    Dim Local_NetworkFamily_Param As Ptr
		    Local_NetworkFamily_Param = COM.SysAllocString( NetworkFamily_Param )
