...
Inherits COM.IDispatch
	...
	#tag Method, Flags = &h0
		Sub Constructor(connectEvents As Boolean = False)
		    ...
		    riid = COM.IIDFromString( "{07BC0875-8488-4FA4-9502-C19E0D9A1443}" )
		    clsid = COM.IIDFromString( "{1D9E571F-B176-42BE-893B-CE976A2D7113}" )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New Drops_Get_Func1( mThis.Ptr( 0 ).Ptr( 18 * COM.SIZEOF_PTR ) )
