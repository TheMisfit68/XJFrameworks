...
Inherits COM.IDispatch
	#tag Method, Flags = &h0
		Sub Analyze()
		    ...
		    Dim func As New Analyze_Func0(mThis.Ptr( 0 ).Ptr(32 * COM.SIZEOF_PTR ))
	...
	#tag Method, Flags = &h0
		Sub Build()
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New Build_Func0(mThis.Ptr( 0 ).Ptr(30 * COM.SIZEOF_PTR ))
		    Call func.Invoke(mThis)
	...
	#tag Method, Flags = &h0
		Sub BuildAll()
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New BuildAll_Func0(mThis.Ptr( 0 ).Ptr(31 * COM.SIZEOF_PTR ))
		    Call func.Invoke(mThis)
	...
	#tag Method, Flags = &h0
		Function Context(varTypeSpecificInfo_Param As Variant, varSpecificInfo_Param As Variant, VarSignature_Param As Variant) As UnityProServer.IContext
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New Context_Get_Func4(mThis.Ptr( 0 ).Ptr(40 * COM.SIZEOF_PTR ))
	...
	#tag Method, Flags = &h0
		Sub Export(FileNameToExport_Param As String, ExportOption_Param As Integer)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New Export_Func2(mThis.Ptr( 0 ).Ptr(39 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Function GetPrivateFiles(bsFilter_Param As String, ByRef pNbFiles_Param As Integer) As Variant
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New GetPrivateFiles_Func3(mThis.Ptr( 0 ).Ptr(47 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Sub GetProjectSettingValue(bsSettingIdent_Param As String, varSettingValue_Param As Variant)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New GetProjectSettingValue_Func2(mThis.Ptr( 0 ).Ptr(49 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Function GetTmpPath() As String
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New GetTmpPath_Func1(mThis.Ptr( 0 ).Ptr(48 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Function GetVersion(ByRef plVersionAutoIncrementset_Param As Integer, ByRef plBuildVersion_Param As Integer, ByRef plMajorVersion_Param As Integer, ByRef plMinorVersion_Param As Integer) As String
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New GetVersion_Func5(mThis.Ptr( 0 ).Ptr(18 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Sub IsEditorValidationRequired()
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New IsEditorValidationRequired_Func0(mThis.Ptr( 0 ).Ptr(51 * COM.SIZEOF_PTR ))
		    Call func.Invoke(mThis)
	...
	#tag DelegateDeclaration, Flags = &h1
		Protected Delegate Function IsEditorValidationRequired_Func0(this As Ptr) As Integer
	#tag EndDelegateDeclaration
	...
	#tag Method, Flags = &h0
		Function IsModified() As Int16
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New IsModified_Func1(mThis.Ptr( 0 ).Ptr(34 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Function ListDeletedById(SignatureBegin_Param As Variant, SignatureEnd_Param As Variant, Filter_Param As Variant) As Variant
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New ListDeletedById_Func4(mThis.Ptr( 0 ).Ptr(33 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag DelegateDeclaration, Flags = &h1
		Protected Delegate Function Pous_Get_Func1(this As Ptr, ByRef ppPous_Param As Ptr) As Integer
	#tag EndDelegateDeclaration
	...
	#tag Method, Flags = &h0
		Function PrivateInfo(FileName_Param As String) As String
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New PrivateInfo_Get_Func2(mThis.Ptr( 0 ).Ptr(41 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Sub PutPrivateFile(bstrFullPathWithName_Param As String)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New PutPrivateFile_Func1(mThis.Ptr( 0 ).Ptr(46 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Sub PutVersion(lVersionAutoIncrementset_Param As Integer, lBuildVersion_Param As Integer, lMajorVersion_Param As Integer, lMinorVersion_Param As Integer)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New PutVersion_Func4(mThis.Ptr( 0 ).Ptr(19 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Sub RestoreDataToPLC(FileName_Param As String)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New RestoreDataToPLC_Func1(mThis.Ptr( 0 ).Ptr(44 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
		    Dim Local_FileName_Param As Ptr
		    Local_FileName_Param = COM.SysAllocString( FileName_Param )
	...
	#tag Method, Flags = &h0
		Sub Save()
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New Save_Func0(mThis.Ptr( 0 ).Ptr(36 * COM.SIZEOF_PTR ))
		    Call func.Invoke(mThis)
	...
	#tag Method, Flags = &h0
		Sub SaveArchive(bsArchiveFilename_Param As String)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New SaveArchive_Func1(mThis.Ptr( 0 ).Ptr(45 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Sub SaveAs(FileName_Param As String)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New SaveAs_Func1(mThis.Ptr( 0 ).Ptr(37 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
		    Dim Local_FileName_Param As Ptr
		    Local_FileName_Param = COM.SysAllocString( FileName_Param )
		    resultCode = func.Invoke(mThis, Local_FileName_Param)
	...
	#tag Method, Flags = &h0
		Sub SaveDataFromPLC(FileName_Param As String, varSaveParametersArray_Param As Variant, pvarSaveParametersArrayUsed_Param As Variant)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New SaveDataFromPLC_Func3(mThis.Ptr( 0 ).Ptr(43 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
		    Dim Local_FileName_Param As Ptr
		    Local_FileName_Param = COM.SysAllocString( FileName_Param )
		    Dim Local_varSaveParametersArray_Param As MemoryBlock = COM.RBVariantToVARIANT(varSaveParametersArray_Param)
	...
	#tag Method, Flags = &h0
		Sub Search(Type_Param As Variant, Name_Param As String, pSearchResult_Param As Variant, pTypesFound_Param As Variant)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New Search_Func4(mThis.Ptr( 0 ).Ptr(38 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Sub TransferAllPCtoPLC()
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New TransferAllPCtoPLC_Func0(mThis.Ptr( 0 ).Ptr(35 * COM.SIZEOF_PTR ))
		    Call func.Invoke(mThis)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New Configuration_Get_Func1( mThis.Ptr( 0 ).Ptr( 22 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New CurrentSignature_Get_Func1( mThis.Ptr( 0 ).Ptr( 13 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New Ddts_Get_Func1( mThis.Ptr( 0 ).Ptr( 26 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New Dfbs_Get_Func1( mThis.Ptr( 0 ).Ptr( 27 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New Documentation_Get_Func1( mThis.Ptr( 0 ).Ptr( 23 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New Efbs_Get_Func1( mThis.Ptr( 0 ).Ptr( 28 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New FctModules_Get_Func1( mThis.Ptr( 0 ).Ptr( 24 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New HasProjectFileName_Get_Func1( mThis.Ptr( 0 ).Ptr( 15 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New InfoBuildState_Get_Func1( mThis.Ptr( 0 ).Ptr( 14 * COM.SIZEOF_PTR ) )
			    Dim resultCode As Integer = func.Invoke( mThis, pVal_Param )
			    If 0 = resultCode Then
			      Return pVal_Param
			    Else
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New InfoCreation_Get_Func1( mThis.Ptr( 0 ).Ptr( 16 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim mb As New MemoryBlock(16)
			    Dim pVariant_Param As Ptr = mb
			    Dim func As New InfoModification_Get_Func1( mThis.Ptr( 0 ).Ptr( 17 * COM.SIZEOF_PTR ) )
			    Dim resultCode As Integer = func.Invoke( mThis, pVariant_Param )
			    If 0 = resultCode Then
			      Dim retVal As Variant = COM.VARIANTToRBVariant( pVariant_Param )
			      COM.FreeVARIANT( pVariant_Param )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New IODdts_Get_Func1( mThis.Ptr( 0 ).Ptr( 29 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New Networks_Get_Func1( mThis.Ptr( 0 ).Ptr( 25 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  #if TargetWindows
			    If mThis = Nil Then Raise New NilObjectException
			    Dim ppPous_Param As Ptr
			    Dim func As New Pous_Get_Func1( mThis.Ptr( 0 ).Ptr( 50 * COM.SIZEOF_PTR ) )
			    Dim resultCode As Integer = func.Invoke( mThis, ppPous_Param )
			    If 0 = resultCode Then
			      If Nil <> ppPous_Param Then
			        Return New UnityProServer.IPous( ppPous_Param )
			      End If
			    Else
			      Raise New COM.COMException("Failed on Pous", resultCode )
			    End If
			  #endif
			  
			End Get
		#tag EndGetter
		Pous As UnityProServer.IPous
	#tag EndComputedProperty
	...
	#tag ComputedProperty, Flags = &h0
		#tag Setter
			Set
			  #if TargetWindows
			    If mThis = Nil Then Raise New NilObjectException
			    Dim func As New PrivateInfo_Put_Func1( mThis.Ptr( 0 ).Ptr( 42 * COM.SIZEOF_PTR ) )
			    Dim Local_rhs_Param As Ptr
			    Local_rhs_Param = COM.SysAllocString( value )
			    Dim resultCode As Integer = func.Invoke( mThis, Local_rhs_Param)
			    If 0 = resultCode Then
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New Program_Get_Func1( mThis.Ptr( 0 ).Ptr( 21 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New ProjectFileName_Get_Func1( mThis.Ptr( 0 ).Ptr( 12 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    If mThis = Nil Then Raise New NilObjectException
			    Dim pVal_Param As Ptr
			    Dim func As New Variables_Get_Func1( mThis.Ptr( 0 ).Ptr( 20 * COM.SIZEOF_PTR ) )
			    Dim resultCode As Integer = func.Invoke( mThis, pVal_Param )
			    If 0 = resultCode Then
