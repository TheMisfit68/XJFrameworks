...
Inherits COM.IDispatch
	#tag Method, Flags = &h0
		Sub CloseEditor()
		    ...
		    Dim func As New CloseEditor_Func0(mThis.Ptr( 0 ).Ptr(18 * COM.SIZEOF_PTR ))
	...
	#tag Method, Flags = &h0
		Sub CloseEditorControl(bstrHMIRWPasswrd_Param As String)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New CloseEditorControl_Func1(mThis.Ptr( 0 ).Ptr(23 * COM.SIZEOF_PTR ))
	...
	#tag Method, Flags = &h0
		Sub Delete()
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New Delete_Func0(mThis.Ptr( 0 ).Ptr(16 * COM.SIZEOF_PTR ))
		    Call func.Invoke(mThis)
	...
	#tag Method, Flags = &h0
		Sub DisplayEditor()
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New DisplayEditor_Func0(mThis.Ptr( 0 ).Ptr(17 * COM.SIZEOF_PTR ))
		    Call func.Invoke(mThis)
	...
	#tag Method, Flags = &h0
		Sub DisplayEditorControl(bstrHMIRWPasswrd_Param As String)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New DisplayEditorControl_Func1(mThis.Ptr( 0 ).Ptr(22 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
		    Dim Local_bstrHMIRWPasswrd_Param As Ptr
		    Local_bstrHMIRWPasswrd_Param = COM.SysAllocString( bstrHMIRWPasswrd_Param )
		    resultCode = func.Invoke(mThis, Local_bstrHMIRWPasswrd_Param)
	...
	#tag Method, Flags = &h0
		Sub Export(FileNameToExport_Param As String, ExportOption_Param As Integer)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New Export_Func2(mThis.Ptr( 0 ).Ptr(19 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Sub ListArrayInfos(Size_Param As Variant, TypeCategory_Param As Variant, MinRanges_Param As Variant, MaxRanges_Param As Variant)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New ListArrayInfos_Func4(mThis.Ptr( 0 ).Ptr(21 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Sub ListSubfields(SubfieldsNamesList_Param As Variant, SubfieldsTypeNameList_Param As Variant, SubfieldsTypeCategoryList_Param As Variant)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New ListSubfields_Func3(mThis.Ptr( 0 ).Ptr(20 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New DescriptiveForm_Get_Func1( mThis.Ptr( 0 ).Ptr( 11 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New InfoSignature_Get_Func1( mThis.Ptr( 0 ).Ptr( 13 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New InfoSize_Get_Func1( mThis.Ptr( 0 ).Ptr( 12 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New InfoVersion_Get_Func1( mThis.Ptr( 0 ).Ptr( 14 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New TypeCategory_Get_Func1( mThis.Ptr( 0 ).Ptr( 10 * COM.SIZEOF_PTR ) )
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New ValidationDate_Get_Func1( mThis.Ptr( 0 ).Ptr( 15 * COM.SIZEOF_PTR ) )
