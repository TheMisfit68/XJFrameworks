...
Inherits COM.IDispatch
	...
	#tag Method, Flags = &h0
		Sub Constructor(connectEvents As Boolean = False)
		    ...
		    riid = COM.IIDFromString( "{06BEE8EF-42B8-11D4-A1E9-000629A2F326}" )
		    clsid = COM.IIDFromString( "{06BEE8F0-42B8-11D4-A1E9-000629A2F326}" )
	...
	#tag Method, Flags = &h0
		Sub Export(FileNameExport_Param As String, ExportOption_Param As Integer)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
	...
	#tag Method, Flags = &h0
		Sub ExportXVM(FileNameExport_Param As String, ExportOption_Param As Integer)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New ExportXVM_Func2(mThis.Ptr( 0 ).Ptr(17 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
		    Dim Local_FileNameExport_Param As Ptr
		    Local_FileNameExport_Param = COM.SysAllocString( FileNameExport_Param )
		    resultCode = func.Invoke(mThis, Local_FileNameExport_Param, ExportOption_Param)
	...
	#tag Method, Flags = &h0
		Sub Import(FileNameToImport_Param As String)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New Import_Func1(mThis.Ptr( 0 ).Ptr(15 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Sub ImportWithStrategy(FileNameToImport_Param As String, psrImportStrategy_Param As epsrImportOption)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New ImportWithStrategy_Func2(mThis.Ptr( 0 ).Ptr(18 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
		    Dim Local_FileNameToImport_Param As Ptr
		    Local_FileNameToImport_Param = COM.SysAllocString( FileNameToImport_Param )
	...
	#tag Method, Flags = &h0
		Function Item(Key_Param As Variant, Id_Param As Integer) As UnityProServer.IVariable
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New Item_Func3(mThis.Ptr( 0 ).Ptr(10 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Sub ListAttributesReturnValues(AttributesKeyCodeList_Param As Variant, IecTypeList_Param As Variant)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New ListAttributesReturnValues_Func2(mThis.Ptr( 0 ).Ptr(14 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Function ListAttributesSupported(ApplicationLevel_Param As String, IdentKeyCode_Param As String) As Variant
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New ListAttributesSupported_Func3(mThis.Ptr( 0 ).Ptr(13 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Sub ListAttributesValues(ListofVariableIds_Param As Variant, Filter_Param As Variant, ListofAttributesToRead_Param As Variant, ListofAttributesValues_Param As Variant, IecTypeList_Param As Variant, ListofErrorCode_Param As Variant, ListofErrorStrings_Param As Variant)
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New ListAttributesValues_Func7(mThis.Ptr( 0 ).Ptr(12 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag Method, Flags = &h0
		Function ListModifiedById(SignatureBegin_Param As Variant, SignatureEnd_Param As Variant) As Variant
		  #if TargetWin32
		    If mThis = Nil Then Raise New NilObjectException
		    Dim func As New ListModifiedById_Func3(mThis.Ptr( 0 ).Ptr(11 * COM.SIZEOF_PTR ))
		    Dim resultCode As Integer
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			    ...
			    Dim func As New _NewEnum_Get_Func1( mThis.Ptr( 0 ).Ptr( 9 * COM.SIZEOF_PTR ) )
