#tag Class
Protected Class Buses
Inherits COM.IDispatch
	#tag Method, Flags = &h0
		Function AddChild(lTopoNumber_Param As Integer, lExtendedNumber_Param As Integer, bsPartNumber_Param As String, bsVersion_Param As String) As UnityProServer.IBus
		  ...
		  If resultCode = 0 Then
		    ...
		    Return New UnityProServer.IBus(Return_ppNewBus_Param)
	...
	#tag Method, Flags = &h0
		Sub Constructor(connectEvents As Boolean = False)
		    ...
		    riid = COM.IIDFromString( "{601680D3-CDE5-4A5D-A258-504B5199121E}" )
		    clsid = COM.IIDFromString( "{C42440B9-AA5F-4D32-B28F-2DF889B1371F}" )
	...
	#tag Method, Flags = &h0
		Shared Function IID() As MemoryBlock
		  Return COM.IIDFromString("{601680D3-CDE5-4A5D-A258-504B5199121E}")
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Function Item(lTopoNumber_Param As Integer, lExtendedNumber_Param As Integer, Id_Param As Integer, IndexNameKey_Param As Variant) As UnityProServer.IBus
		  If mThis = Nil Then Raise New NilObjectException
		  ...
		  Dim Return_ppNewBus_Param As Ptr
		  resultCode = func.Invoke(mThis, lTopoNumber_Param, lExtendedNumber_Param, Id_Param, Local_IndexNameKey_Param, Return_ppNewBus_Param)
	...
	#tag DelegateDeclaration, Flags = &h1
		Protected Delegate Function Item_Func5(this As Ptr, lTopoNumber_Param As Integer, lExtendedNumber_Param As Integer, Id_Param As Integer, IndexNameKey_Param As Ptr, ByRef ppNewBus_Param As Ptr) As Integer
	#tag EndDelegateDeclaration
	...
	#tag Method, Flags = &h0
		Sub Operator_Convert(rhs As COM.IUnknown)
		  ...
		  Dim p As Ptr
		  If 0 = rhs.QueryInterface( UnityProServer.IBuses.IID, p ) Then
		    mThis = p
		  Else
	...
	#tag Method, Flags = &h0
		Function ReplaceChild(lTopoNumber_Param As Integer, lExtendedNumber_Param As Integer, bsActualPartNumber_Param As String, bsActualVersion_Param As String, bsNewPartNumber_Param As String, bsNewVersion_Param As String) As UnityProServer.IBus
		  If mThis = Nil Then Raise New NilObjectException
		  ...
		  Dim Return_ppNewBus_Param As Ptr
		  resultCode = func.Invoke(mThis, lTopoNumber_Param, lExtendedNumber_Param, Local_bsActualPartNumber_Param, Local_bsActualVersion_Param, Local_bsNewPartNumber_Param, Local_bsNewVersion_Param, Return_ppNewBus_Param)
	...
	#tag DelegateDeclaration, Flags = &h1
		Protected Delegate Function ReplaceChild_Func7(this As Ptr, lTopoNumber_Param As Integer, lExtendedNumber_Param As Integer, bsActualPartNumber_Param As Ptr, bsActualVersion_Param As Ptr, bsNewPartNumber_Param As Ptr, bsNewVersion_Param As Ptr, ByRef ppNewBus_Param As Ptr) As Integer
	#tag EndDelegateDeclaration
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  If 0 = resultCode Then
			    If Nil <> ppNewBus_Param Then
			      Return New UnityProServer.IBus( ppNewBus_Param )
			    End If
			  Else
			...
			End Get
		#tag EndGetter
		LocalChild As UnityProServer.IBus
	#tag EndComputedProperty
