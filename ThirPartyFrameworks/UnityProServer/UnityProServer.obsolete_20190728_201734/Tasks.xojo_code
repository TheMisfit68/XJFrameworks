...
Inherits COM.IDispatch
	...
	#tag Method, Flags = &h0
		Function Item(EnumTaskName_Param As Variant, Id_Param As Integer = 0) As UnityProServer.ITask
		  If mThis = Nil Then Raise New NilObjectException
	...
	#tag Method, Flags = &h0
		Function JVItem(EnumTaskName_Param As Variant, Id_Param As Integer = 0) As UnityProServer.ITask
		  If mThis = Nil Then Raise New NilObjectException
		  ...
		  // COM.FreeVARIANT(Local_EnumTaskName_PTasksaram)
	...
	#tag DelegateDeclaration, Flags = &h1
		Protected Delegate Function JVItem_Func3(this As Ptr, EnumTaskName_Param As UnityEnum, Id_Param As Integer, ByRef ppNewTask_Param As Ptr) As Integer
	#tag EndDelegateDeclaration
