...
Inherits COM.IDispatch
	#tag Method, Flags = &h0
		Function AddChild(lTopoNumber_Param As Integer, lExtendedNumber_Param As Integer, bsPartNumber_Param As String, bsVersion_Param As String) As UnityProServer.IDrop
		  ...
		  Dim Return_ppNewDrop_Param As Ptr
		  resultCode = func.Invoke(mThis, lTopoNumber_Param, lExtendedNumber_Param, Local_bsPartNumber_Param, Local_bsVersion_Param, Return_ppNewDrop_Param)
		  COM.SysFreeString(Local_bsPartNumber_Param)
		  COM.SysFreeString(Local_bsVersion_Param)
		  If resultCode = 0 Then
		    If Nil = Return_ppNewDrop_Param  Then Return Nil
		    Return New UnityProServer.IDrop(Return_ppNewDrop_Param)
	...
	#tag DelegateDeclaration, Flags = &h1
		Protected Delegate Function AddChild_Func5(this As Ptr, lTopoNumber_Param As Integer, lExtendedNumber_Param As Integer, bsPartNumber_Param As Ptr, bsVersion_Param As Ptr, ByRef ppNewDrop_Param As Ptr) As Integer
	...
	#tag Method, Flags = &h0
		Sub Constructor(connectEvents As Boolean = False)
		    ...
		    riid = COM.IIDFromString( "{43390B2E-629C-44A0-8267-ECC4AE65E626}" )
		    clsid = COM.IIDFromString( "{CF1E4F44-83C8-4CF7-9294-CF4F961E5271}" )
	...
	#tag Method, Flags = &h0
		Shared Function IID() As MemoryBlock
		  Return COM.IIDFromString("{43390B2E-629C-44A0-8267-ECC4AE65E626}")
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Function Item(lTopoNumber_Param As Integer, lExtendedNumber_Param As Integer, Id_Param As Integer, IndexNameKey_Param As Variant) As UnityProServer.IDrop
		  If mThis = Nil Then Raise New NilObjectException
		  ...
		  Dim Return_ppNewDrop_Param As Ptr
		  resultCode = func.Invoke(mThis, lTopoNumber_Param, lExtendedNumber_Param, Id_Param, Local_IndexNameKey_Param, Return_ppNewDrop_Param)
	...
	#tag DelegateDeclaration, Flags = &h1
		Protected Delegate Function Item_Func5(this As Ptr, lTopoNumber_Param As Integer, lExtendedNumber_Param As Integer, Id_Param As Integer, IndexNameKey_Param As Ptr, ByRef ppNewDrop_Param As Ptr) As Integer
	#tag EndDelegateDeclaration
	...
	#tag DelegateDeclaration, Flags = &h1
		Protected Delegate Function LocalChild_Get_Func1(this As Ptr, ByRef ppNewDrop_Param As Ptr) As Integer
	#tag EndDelegateDeclaration
	...
	#tag Method, Flags = &h0
		Sub Operator_Convert(rhs As COM.IUnknown)
		  ...
		  Dim p As Ptr
		  If 0 = rhs.QueryInterface( UnityProServer.IDrops.IID, p ) Then
		    mThis = p
		  Else
	...
	#tag Method, Flags = &h0
		Function ReplaceChild(lTopoNumber_Param As Integer, lExtendedNumber_Param As Integer, bsActualPartNumber_Param As String, bsActualVersion_Param As String, bsNewPartNumber_Param As String, bsNewVersion_Param As String) As UnityProServer.IDrop
		  If mThis = Nil Then Raise New NilObjectException
		  ...
		  Dim Return_ppNewDrop_Param As Ptr
		  resultCode = func.Invoke(mThis, lTopoNumber_Param, lExtendedNumber_Param, Local_bsActualPartNumber_Param, Local_bsActualVersion_Param, Local_bsNewPartNumber_Param, Local_bsNewVersion_Param, Return_ppNewDrop_Param)
	...
	#tag DelegateDeclaration, Flags = &h1
		Protected Delegate Function ReplaceChild_Func7(this As Ptr, lTopoNumber_Param As Integer, lExtendedNumber_Param As Integer, bsActualPartNumber_Param As Ptr, bsActualVersion_Param As Ptr, bsNewPartNumber_Param As Ptr, bsNewVersion_Param As Ptr, ByRef ppNewDrop_Param As Ptr) As Integer
	#tag EndDelegateDeclaration
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  If mThis = Nil Then Raise New NilObjectException
			  Dim ppNewDrop_Param As Ptr
			  Dim func As New LocalChild_Get_Func1( mThis.Ptr( 0 ).Ptr( 44 ) )
			  Dim resultCode As Integer = func.Invoke( mThis, ppNewDrop_Param )
			  If 0 = resultCode Then
			    If Nil <> ppNewDrop_Param Then
			      Return New UnityProServer.IDrop( ppNewDrop_Param )
			    End If
			  Else
			...
			End Get
		#tag EndGetter
		LocalChild As UnityProServer.IDrop
	#tag EndComputedProperty
